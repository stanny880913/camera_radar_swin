...
class SingleStageDetector(BaseDetector):
    ...
    #             new_img_height = output_tensor.shape[2] // 4
    #             new_img_width = output_tensor.shape[3] // 4
    ...
    #     x_other_resize = [F.interpolate(x_o, size=(x_o.shape[2] // 4, x_o.shape[3] // 4), mode='bilinear', align_corners=False) for x_o in x_other]
    ...
    #         lwa_x_other = x_o * xxlambaLWA[:,xx:xx+1,:,:] 
    #         x_cat.append(torch.cat([x_i, lwa_x_other], dim=1))
